...
class REPL {
  ...
  async rebootESP32() {
    try {
      ...
      console.log("ESP32 rebooted successfully!");
    } catch (error) {
      console.error(error);
    }
  }
